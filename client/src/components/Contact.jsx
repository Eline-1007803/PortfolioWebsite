                ...
                <form style={{maxWidth: '600px', margin: '0 auto'}} className='text-left'>
                    <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px'}}>
                        ...
                        <div style={{display: 'flex', flexDirection: 'column'}}>
                            ...
                            <input style={{padding: "12px", borderRadius: "8px", border: "1px solid lightgray"}} className='rounded w-75 p-1' type='text' id='lastName'/>
                        </div>

                    </div>
                    <div style={{display: 'flex', flexDirection: 'column'}}>
                        <label htmlFor='email'>Email</label>
                        <input style={{padding: "12px", borderRadius: "8px", border: "1px solid lightgray"}} className='rounded mb-4 p-2' type='text' id='email'/>
                        ...
                        <input style={{padding: "12px", borderRadius: "8px", border: "1px solid lightgray"}} className='rounded mb-4 p-2' type='text' id='subject'/>

                        <label htmlFor='message'>Bericht</label>
                        <textarea style={{padding: "12px", borderRadius: "8px", border: "1px solid lightgray"}}  className='rounded w-100 h-2/3' id='message'/>
                    </div>
